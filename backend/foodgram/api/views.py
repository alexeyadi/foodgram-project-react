...
from api.serializers import (IngredientSerializer, ShortRecipeSerializer,
                             RecipeCreateSerializer, RecipeSerializer,
                             SubscriptionSerializer, TagSerializer)
from api.utils import delete_for_actions, get_list_txt, post_for_actions
...
class SubscriptionsViewSet(viewsets.GenericViewSet):
    '''Viewset for subscribe and unsubscribe.'''
